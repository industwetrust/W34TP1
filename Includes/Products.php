...
<?php
    ...
    if (!isset($_GET["Category"])) {
        $categories = $mySqli->query("SELECT * FROM Categories WHERE (SELECT COUNT(*) FROM ProductsCategories WHERE CategoryID = Categories.CategoryID) LIMIT " . ($ITEMS_SHOWN_PER_PAGE * $page) . " , " . $ITEMS_SHOWN_PER_PAGE);
        ...
        while($row = $products->fetch_assoc()) {
            ...
            echo "<div class='span3 element category01 isotope-item' data-category='category01' style='position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(" . $posX . "px, " . $posY . "px, 0px);'>";
                ...
                echo "<div class='hover_img'>";
                    echo "<a href='index.php?page=Produits&Product=" . $row["ProductID"] . "' class='preloader' style='background-image: none; background-position: initial initial; background-repeat: initial initial;'>";
                ...
                echo "<div class='item_description'>";
                    ...
                    echo "<div class='descr'>Prix: " . $row["Price"] . "<br />Ajouter au panier:<input type'text' name='' style='width: 30px; height: 14px;'></div>";
...
//            
//            echo "<div class='itemImageContainer'><img class='itemImage' src='" . $row["ImageURL"] . "' /></div>";
